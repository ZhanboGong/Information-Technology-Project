  ...
  <div class="min-h-screen bg-[#f8fafc] flex overflow-hidden">
    <aside class="w-64 bg-white/70 backdrop-blur-xl border-r border-white/60 flex flex-col z-50">
      ...
      <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto scrollbar-hide">
        ...
        <router-link to="/admin/knowledge-points" 
          class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all text-gray-500 hover:bg-pink-50 hover:text-pink-600 group"
          active-class="bg-pink-600 !text-white shadow-lg shadow-pink-200">
          <BookOpen size="20" />
          <span class="text-sm font-bold">Knowledge Base</span>
        </router-link>
        ...
        <router-link to="/admin/ai-usage" 
          class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all text-gray-500 hover:bg-cyan-50 hover:text-cyan-600 group"
          active-class="bg-cyan-600 !text-white shadow-lg shadow-cyan-200">
          <BarChart2 size="20" />
          <span class="text-sm font-bold">AI Usage</span>
        </router-link>
...
import { 
  ...
  Settings, Activity, LogOut, FileText, BarChart2, BookOpen
