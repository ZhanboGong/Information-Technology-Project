    ...
    />
      ...
      <div class="flex-1 px-4 space-y-1">
        ...
        <router-link to="/teacher/courses" class="nav-item" active-class="active">
            <Library size="18" /><span>Courses</span>
        </router-link>
        ...
        <router-link to="/teacher/plagiarism" class="nav-item" active-class="active">
            <Search size="18" /><span>Plagiarism Check</span>
        </router-link>

        <router-link to="/teacher/appeals" class="nav-item" active-class="active">
          <ShieldAlert size="18" /><span>Grade Appeals</span>
        </router-link>
    ...
    <main class="flex-1 ml-64 p-10 relative overflow-y-auto h-screen custom-scrollbar">
      <header class="flex justify-between items-center mb-10 w-full gap-4">
        <div class="flex items-center gap-4 flex-1 min-w-0">
          <button v-if="route.path.includes('workspace') || route.path.includes('appeals')" @click="router.push('/teacher/grading')" 
...
import { 
  ...
  LogOut, Bell, User, ArrowLeft, Clock, ShieldAlert, Settings, Search, ExternalLink, CheckCircle2
