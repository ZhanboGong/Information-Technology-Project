...
const routes = [
  ...
  // 2. Admin 管理端 (独立 Layout)
  {
    ...
    children: [
      ...
      { path: 'knowledge-points', name: 'KPManagement', component: () => import('../views/admin/KPManagementView.vue') },
      ...
      { path: 'ai-usage', name: 'AIUsage', component: () => import('../views/admin/AIUsageView.vue') },
    ]
  },
  ...
  // 3. 教师端 (使用 MainLayout)
  {
    ...
    children: [
      ...
      { path: 'plagiarism', name: 'PlagiarismCheck', component: () => import('../views/teacher/PlagiarismCheckView.vue') },
      {
        path: 'appeals',
        name: 'TeacherAppeals',
        component: () => import('../views/teacher/TeacherAppealCenter.vue')
      },
      {
        path: 'settings',
        name: 'Settings',
